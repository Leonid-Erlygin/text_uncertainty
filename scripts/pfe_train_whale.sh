docker run \
 ...
 --cpus=40 \
 --user ${UID}:${UID} \
 --name ${USER}_$(basename $(dirname "$PWD"))_pfe_train_whale \
 ...
 python3 training/trainers/train_multiple_runs_scf.py -cn=train_pfe_whale #train_scf_base train_scf_blur
